...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("Syphix/assets/font2.ttf", 30)
        font = ImageFont.truetype("Syphix/assets/font.ttf", 30)
        title_font = ImageFont.truetype("Syphix/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("Syphix/assets/play_icons.png")
